...
• After the analysis I did data visualisation using python libraries matplotlib and seaborn. And at last I have Created a Dashboard using PowerBI

## The following steps are performed:

### • Fiinding the  Null value present in our dataset
...
### • Checking Various brands available
